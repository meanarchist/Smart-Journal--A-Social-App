...
class RegisterController: UIViewController {
    ...
    // MARK: - UI Components
    private let headerView = AuthHeaderView(title: "smart journal", subTitle: "Start growing today!")
    ...
    private func setupUI() {
        ...
        let buttonBackgroundColor = textColor // Background color same as text color for the sign-up button
        ...
        usernameField.font = helveticaBold
        usernameField.textColor = textColor
        usernameField.backgroundColor = textInputBackgroundColor // Set background color
        ...
        signUpButton.titleLabel?.font = helveticaBold
        signUpButton.backgroundColor = buttonBackgroundColor // Set background color
        signUpButton.setTitleColor(.white, for: .normal) // Text color set to white
        
        signInButton.titleLabel?.font = helvetica
        signInButton.setTitleColor(textColor, for: .normal)
